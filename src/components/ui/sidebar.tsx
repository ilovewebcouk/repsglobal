      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) border-r-0 border-l-0 bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[12px] md:peer-data-[variant=inset]:shadow",
          className,
        )}
        {...props}
      />
