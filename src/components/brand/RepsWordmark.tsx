...
export function RepsWordmark({ className, title = "REPs" }: RepsWordmarkProps) {
  return (
    ...
    >
      ...
      <polygon points="73.8 18.72 126.8 18.72 118.16 29.38 88.71 29.38 88.71 35.64 129.68 35.64 120.17 48.17 73.8 48.17 73.8 18.72" />
      <polygon points="73.8 0 129.6 0 119.96 12.53 73.8 12.53 73.8 0" />
