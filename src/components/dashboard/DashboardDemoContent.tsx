    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      <Card>
        <PanelHeader
          ...
          icon={Trophy}
          right={<Button asChild variant="outline" size="sm" className="h-8 rounded-[8px] bg-reps-panel-soft border-reps-border text-[12px]"><Link to="/dashboard/website">View website</Link></Button>}
        />
        ...
        <ul className="space-y-3">
          {CLIENT_ALERTS.map((a) => (
            <li key={a.name} className="flex items-start gap-3">
              <img src={a.avatar} alt="" className="h-9 w-9 shrink-0 rounded-[10px] object-cover" />
              <div className="min-w-0 flex-1">
        ...
        <ul className="mt-3 space-y-2.5">
          {LEADS.map((l) => (
            <li key={l.name} className="flex items-center gap-3">
              <img src={l.avatar} alt="" className="h-8 w-8 rounded-[10px] object-cover" />
              <div className="min-w-0 flex-1">
        ...
        <div className="grid grid-cols-3 gap-2">
          {SPOTLIGHT.map((s) => (
            <div key={s.name} className="rounded-[12px] border border-reps-border bg-reps-panel-soft p-3 text-center">
              <img src={s.avatar} alt="" className="mx-auto h-10 w-10 rounded-[10px] object-cover" />
