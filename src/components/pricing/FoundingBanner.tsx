  ...
  return (
    <div className="mx-auto flex max-w-[1320px] flex-col items-center justify-between gap-3 px-6 py-4 text-center lg:flex-row lg:px-10 lg:text-left">
      <div className="flex items-center gap-3 text-[14px] text-white/85">
        <Badge
          variant="outline"
          className="inline-flex items-center gap-1.5 rounded-full border-reps-orange-border bg-reps-orange-soft px-2.5 py-0.5 text-[11px] uppercase tracking-wider text-reps-orange"
        >
      ...
      <span className="text-[12px] text-white/55">Limited spots · founder price stays while you stay · includes a 30-day free trial</span>
    </div>
  );
}
