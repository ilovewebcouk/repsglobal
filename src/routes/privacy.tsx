...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How REPs collects, uses and protects your personal data under UK GDPR." },
      { property: "og:title", content: "Privacy policy — REPs" },
      { property: "og:description", content: "Our UK GDPR-aligned privacy practices." },
    ],
  }),
  component: () => (
    <LegalShell
      ...
      intro="REPs takes the privacy of our professionals and clients seriously. This policy explains what data we collect, how we use it, and the rights you have under UK GDPR."
      sections={[
        ...
        { id: "international", title: "International transfers", body: <p>Some processors operate outside the UK. We rely on UK Adequacy decisions and Standard Contractual Clauses where appropriate.</p> },
        ...
        { id: "your-rights", title: "Your rights", body: <p>Under UK GDPR you can access, rectify, erase, restrict and port your data, and object to processing. Email <a href="mailto:privacy@repsglobal.com" className="font-semibold text-reps-orange hover:underline">privacy@repsglobal.com</a> to exercise these.</p> },
        ...
        { id: "complaints", title: "Complaints", body: <p>You can lodge a complaint with the UK Information Commissioner's Office at <a href="https://ico.org.uk" className="font-semibold text-reps-orange hover:underline">ico.org.uk</a>.</p> },
      ]}
    />
  ),
});
