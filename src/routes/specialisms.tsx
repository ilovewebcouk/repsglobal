    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1320px] px-6 pb-20 pt-20 lg:px-10 lg:pb-24 lg:pt-24">
        <div className="flex flex-col items-start">
          ...
          <h1
            className="mt-6 max-w-[920px] animate-fade-in font-display text-[36px] font-bold leading-[1.04] text-white sm:text-[46px] lg:text-[66px]"
          ...
          <p
            className="mt-6 max-w-[640px] animate-fade-in text-[16px] leading-relaxed text-white/75"
