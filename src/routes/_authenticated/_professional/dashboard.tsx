      ...
      {status.isLoading ? (
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 items-stretch gap-4 xl:grid-cols-12">
            <div className="flex min-h-[340px] xl:col-span-8">
              <NeedsAttention
            ...
            <div className="flex min-h-[340px] xl:col-span-4">
          ...
          <div className="grid grid-cols-1 items-stretch gap-4 xl:grid-cols-12">
            <div className="flex min-h-[320px] xl:col-span-8">
            ...
            <div className="flex min-h-[320px] xl:col-span-4">
          ...
          <div className="grid grid-cols-1 items-stretch gap-4 xl:grid-cols-12">
            <div className="flex min-h-[300px] xl:col-span-8">
              <CpdMini
            ...
            <div className="flex min-h-[300px] xl:col-span-4">
