        ...
        <>
          <td className="px-3 py-3 text-white/75">{row.lastLoginAt ? (
            <Tooltip>
              ...
              <TooltipContent side="top" className="bg-reps-black text-white">{new Date(row.lastLoginAt).toLocaleString()}</TooltipContent>
            </Tooltip>
          ...
          <td className="px-3 py-3 text-white/45">
            <Tooltip>
              ...
              <TooltipContent side="top" className="bg-reps-black text-white">Wired once course + pro-link tables land</TooltipContent>
            </Tooltip>
          </td>
