...
export const COMPETITORS: Record<Competitor["slug"], Competitor> = {
  trainerize: {
    ...
    addOns: [
      { name: "Custom Branded App (Pro)", cost: "$169 one-time setup fee", note: "Pro tier only; included free on Studio Plus" },
      { name: "Stripe Integrated Payments", cost: "$10/mo", note: "Required for in-app card payments on Grow & Pro" },
      { name: "Advanced Nutrition Coaching", cost: "$20/mo (Pro 5-15) · $45/mo (Pro 30-200)", note: "Includes Smart Meal Planner; free on Studio" },
      { name: "Video Coaching", cost: "$10/mo", note: "50h video calls + 100h streaming/month bundled" },
      { name: "Business Add-on", cost: "$25/mo", note: "Scheduling, products, referrals; bundles Stripe Payments + Video Coaching" },
    ],
    workedExample: [
      {
        ...
        addOnsApplied: [
          ...
          { name: "Advanced Nutrition Coaching", cost: 20 },
        ],
        total: 39,
      },
      {
        ...
        addOnsApplied: [
          { name: "Stripe Payments add-on", cost: 10 },
          { name: "Advanced Nutrition Coaching (Pro 30+)", cost: 45 },
          { name: "Branded App (amortised, $169 ÷ 12mo)", cost: 14 },
        ],
        total: 118,
      },
      {
        label: "Pro slider (~75 clients) + full add-on stack",
        clients: 75,
        base: 79,
        addOnsApplied: [
          { name: "Stripe Payments add-on", cost: 10 },
          { name: "Advanced Nutrition Coaching (Pro 30+)", cost: 45 },
          { name: "Branded App (amortised, $169 ÷ 12mo)", cost: 14 },
          { name: "Video Coaching add-on", cost: 10 },
        ],
        total: 158,
      },
    ],
